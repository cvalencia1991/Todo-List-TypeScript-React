...
const TaskForm: React.FC<TaskFormType> = ({ handleSubmit, handlekeypress, setNewTask, newTask }) => (
  <form onSubmit={handleSubmit}>
    <div className="container flex rounded px-4 bg-[--very-light-gray] items-center justify-evenly desktop:h-16 dark:bg-[--very-dark-desaturated-blue]">
        <input
          className="appearance-none w-6 h-5 p-3 ml-3 mr-[10px] cursor-pointer rounded-full border border-[--dark-grayish-blue]
