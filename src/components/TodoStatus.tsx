...
const TodoStatus = ({tasks, activeTask,completedTask,allTask,clearCompleted}:TodoStatusProps) => {
    ...
    return (
        ...
        <>
        <div className={`container flex shadow-2xl ${tasks.length === 0 ? "desktop:w-[35em] mobile:w-[18em] ": "desktop:w-full mobile:w-full"} text-[18px] font-josefin justify-between bg-[--very-light-gray] text-[--very-dark-grayish-blue]
            h-12 items-center px-4 relative  dark:bg-[--very-dark-desaturated-blue] dark:text-[--light-grayish-blue]  ${tasks.length === 0 ? "rounded": "rounded-b"} `}>
