    ...
    return (
        ...
        >
            <div className="flex items-center">
                ...
                />
                <h2 className={` text-base font-josefin text-[--very-dark-grayish-blue] dark:text-[--dark-grayish-blue] ${(checked ? "line-through text-[--very-dark-grayish-blue]" : "")}`}>{task.name}</h2>
            </div>
                <button
